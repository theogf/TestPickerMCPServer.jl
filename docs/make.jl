...
DocMeta.setdocmeta!(TestPickerMCPServer, :DocTestSetup, :(using TestPickerMCPServer); recursive = true)
...
makedocs(;
    modules = [TestPickerMCPServer],
    authors = "Théo Galy-Fajou <theo.galyfajou@gmail.com>",
    repo = "https://github.com/theogf/TestPickerMCPServer.jl/blob/{commit}{path}#{line}",
    sitename = "TestPickerMCPServer.jl",
    format = Documenter.HTML(; canonical = "https://theogf.github.io/TestPickerMCPServer.jl"),
    pages = list_pages(),
)

deploydocs(; repo = "github.com/theogf/TestPickerMCPServer.jl")
